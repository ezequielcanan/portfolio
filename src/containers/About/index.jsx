  ...
  return (
    <Section id={"about"} className={`flex flex-col gap-y-[100px] p-10 bg-[url('/about-background.webp')] bg-third/80 md:bg-third/60 bg-right-bottom md:bg-left-top bg-cover bg-no-repeat bg-fixed bg-blend-multiply xl:h-screen`}>
      ...
      <div className="md:px-[30px] flex flex-col items-start gap-y-[50px] text-fourth">
        <Text className={"flex flex-col items-start"} text={"I've studied in CoderHouse a full stack career, I finished the frontend section and now I'm doing the backend one."} title={"Education"} size={"md"}>
          <a className={"flex gap-x-[20px] mt-[30px] text-2xl bg-secondary text-primary p-4 rounded duration-[.5s] hover:bg-fourth"} href="/EzequielCanan.pdf" download>Resume <GoDownload className="animate-pulse text-[1.3em]" /></a>
        </Text>
      </div>
      <div className="md:px-[30px] flex flex-col items-start gap-y-[50px] text-fourth">
